<div {{ $attributes->merge(['class' => 'flex items-center']) }}>
  <a
    href="https://www.facebook.com/hikmal.saputra.351?mibextid=ZbWKwL"
    target="_blank"
    class="
         w-10
         h-10
  ...
  <a
    href="https://x.com/genmvamos?t=lRH5LVvjLiDCQ2C-ykyXVQ&s=09"
    target="_blank"
    class="
       w-10
       h-10
  ...
  <a
    href="https://youtu.be/5XZMvB_TCIw?si=4So486fQKUkv3wbn"
    target="_blank"
    class="
       w-10
       h-10
  ...
  <a
    href="https://www.instagram.com/gv_hs23?igsh=YzljYTk1ODg3Zg=="
    target="_blank"
    class="
       w-10
       h-10
